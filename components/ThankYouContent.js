...
const LABELS = {
  en: {
    ...
    heading: "You\u2019re In.",
    description:
      "You just subscribed to The Crash Log \u2014 a bilingual newsletter about AI and tech gone off the rails. New issues land in your inbox as they publish. No spam, no fluff, just the failures that matter.",
  ...
  es: {
    ...
    heading: "\u00A1Listo!",
    description:
      "Te suscribiste a The Crash Log \u2014 un bolet\u00EDn biling\u00FCe sobre la IA y la tecnolog\u00EDa descarrilada. Las nuevas ediciones llegan a tu bandeja de entrada cuando se publican. Sin spam, sin relleno, solo las fallas que importan.",
